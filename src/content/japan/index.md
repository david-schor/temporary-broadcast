...
subtitle: '/dʒəˈpæn/'
date: 2026-05-27
description: 'Our last project took us to Japan, where we spent a month exploring the legendary snow of Hokkaido on splitboards and skis. Deep powder, stunning winter landscapes, and unforgettable encounters with Japanese culture made this adventure one for the books.'
author: 'David Schor'
tags: ["japan", "project", "powder"]
gallery: "japan"
---
...
Speaking of food: the language barrier regularly led to surprises and entertainment we hadn't planned for. Our Japanese extended to "good day", "thank you very much" and "beer", and honestly that got us surprisingly far. For everything else: Google Translate. For everything Google Translate then produced: luck and courage. So it happened that half a chicken turned out to be duck, or something completely different from what was expected ended up on the table. Particularly "promising" sounding dishes included names that were, let's say, eyebrow-raising. We decided against ordering those, as we genuinely had no idea what we would have been served. And some surprises require even more courage than a steep couloir. Small tip: there are dedicated translation apps out there and we can only warmly recommend them!
